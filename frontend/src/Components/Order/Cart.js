...
const products = [
  ...
  { id: 5, name: "Matcha (Powdered Green Tea)", price: 20, image: "https://placehold.co/400x300?text=Matcha" },
  { id: 6, name: "Dragon Well (Longjing)", price: 18, image: "https://placehold.co/400x300?text=Dragon+Well" }
];
        ...
        <section className="cart-section">
          ...
          {cart.length === 0 ? (
            <div className="empty-cart">
              <img
                src="https://placehold.co/300x150?text=Cart+is+Empty"
